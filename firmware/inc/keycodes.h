...
// Standard HID keycodes are 8 bit values. We will use 16 bits for an extra 8 bits for the internal features (ie layer shift, RGB manipulation, etc)
#define EXTRA_KEYCODES_SHIFT (8)
#define HID_KEYCODE_MASK (0xFF)
#define EXTRA_KEYCODE_MASK (0xFF << EXTRA_KEYCODES_SHIFT)
...
enum keycodes
{
    ...
    // 0x0004-0x00FF are standard HID keycodes
    KC_A = 0x0004,
    KC_B = 0x0005,
    KC_C = 0x0006,
    KC_D = 0x0007,
    ...
    KC_RIGHT_ALT = 0x00E6,
    KC_RIGHT_GUI = 0x00E7,
    // 0x0100-0x1FFF are mod keys TODO
    // 0x2000-0x21FF are layers TODO
};
...
// Helpers
#define IS_KC_BASIC(code) ((code) > KC_BASIC && (code) < KC_BASIC_MAX)
